...
public class Delgado_Agustin_Rodriguez_Alejandro_ActEV_UT4_Final {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("");
        GestorHotel.MostrarReservasGenerales();
        ...
        //Validacion si la habitacion esta reservada y la intentan reservar
        vc.No_Reservar_Habitacion_Reservada();
        GestorHotel.guardarReserva(reserva7);
        ...
        vc.BuscarReservasActivasPorCliente();
